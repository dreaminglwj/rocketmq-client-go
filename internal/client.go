...
//go:generate mockgen -source client.go -destination mock_client.go -self_package github.com/dreaminglwj/rocketmq-client-go/internal  --package internal RMQClient
