...
//go:generate mockgen -source namesrv.go -destination mock_namesrv.go -self_package github.com/dreaminglwj/rocketmq-client-go/internal  --package internal Namesrvs
